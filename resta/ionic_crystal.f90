...
read*, N
allocate(crystal(N,3))                    ! 1 riga posizione, 2 riga anione-catione, 3 riga orbitali filled (0,1,2)
...
!finora inutile: non devo essere io ad inizializzare il filling, ma devo essere io a calcolare il ground state dell'hamiltoniana diagonalizzandola e trovando il minimo dell'energia e l'autostato associato
